...
<body class="">
    ...
    <div class="content">
        ...
        <div class="row">
            <div class="col-md-12">
                <form class="form-horizontal" name="form1" method="post" action="reporte-main.php" target="_blank">
                    <div class="panel panel-default">
                        <div class="panel-body bg-white">
                            ...
                            <!-- Estado del Ticket -->
                            <div class="form-group">
                                <label class="col-md-3 col-xs-12 control-label">Estado del Ticket</label>
                                <div class="col-md-6 col-xs-12">
                                    <div class="input-group">
                                        <span class="input-group-addon"><span class="fa fa-ticket"></span></span>
                                        <select name="estado_ticket" id="estado_ticket" class="form-control" required>
                        ...
                        <div class="panel-footer">
                            ...
                            <input type="submit" value="Generar Reporte" name="generar_reporte_main" class="btn btn-primary pull-right">
                        </div>
                    </div>
                </form>
            </div>
